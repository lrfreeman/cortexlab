...
generated quantities {
    ...
    // Name-space for the loop over trials
    {
        ...
        for (t_i in 1:nTrials_test) {
            ...
            Qeff = choices_test[t_i]*(beta_rl * Q + beta_bias);
            ...
            if ((u_trial - Q) > 0) {
                Q = (1-positive_alpha_rl) * Q + positive_alpha_rl * choices_test[t_i] * u_trial;
            }

            else if ((u_trial - Q) < 0) {
                Q = (1-negative_alpha_rl) * Q + negative_alpha_rl * choices_test[t_i] * u_trial;
            }
