...
#Misc----------------------------------------------------------------------
test_file = "/Users/laurence/Desktop/Neuroscience/mproject/data/Analysed_videos_CSVs_DLC/video_snippet_KM011_2020-03-19_trial92DLC_resnet50_Master_ProjectAug13shuffle1_200000.csv"
...
def is_licking_spout(df):
    ...
    print("The mouse is licking the Grape spout on these frames:", len(frames_licking_grape))
    print("The mouse is licking the Cherry spout on these frames:", len(frames_licking_cherry))

#Test
df, frame_is_licking = is_licking(test_file)
is_licking_spout(df)
print("The mouse is licking on these frames:", len(frame_is_licking))
