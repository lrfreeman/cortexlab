...
cell_ID = 5 #Define the unit to filter spike times on
synthetic_trial_number = 800
length = 100000 #Create an artificial number of spikes of lenght....
shift_back = 10 #15 would be 1.5 seconds if bin count is set to 0.1 above - How far should the kernel look back?
