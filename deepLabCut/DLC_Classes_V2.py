...
class DataProcessing:
    ...
    def load_data(self, session_data):
        ...
        self.lock_and_count(self.spike_df)
...
class Histogram(DataProcessing):
    def __init__(self, cell_ID, spike_df, trial_df):
        self.cell_ID = cell_ID
        spike_counts, bin_edges, bin_centres = self.lock_and_count(spike_df.loc[(spike_df["cluster_ids"] == cell_ID)])
